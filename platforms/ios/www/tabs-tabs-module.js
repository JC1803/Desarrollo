...
var TabsPage = /** @class */ (function () {
    function TabsPage(menu, ap, localNotifications, postPvdr) {
        this.menu = menu;
        this.ap = ap;
    ...
    TabsPage.prototype.simpleNotif = function () {
    ...
    TabsPage.prototype.Verificar = function () {
        if (this.mostrarnun == this.numNoti) {
        }
        else if (this.mostrarnun < this.numNoti) {
            this.mostrarnun = this.numNoti;
            this.simpleNotif();
        }
        else if (this.mostrarnun > this.numNoti) {
